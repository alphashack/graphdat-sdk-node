...
timedContext.prototype = {
	...
	// Pass function to call as first param, followed by arguements
	// Assumes last param is callback
	asyncCall:function(fnc)
	{
		if(gd.debug && gd.debug.context_trace) gd.gdLog(gd.logType.Info, 'asyncCall in');
