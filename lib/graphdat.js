...
<<<<<<< HEAD
	json = JSON.parse(fs.readFileSync('node_modules/graphdat/package.json', 'utf8'));
	this.version = json.version;
=======
	this.version = '0.4.1';
>>>>>>> parent of 5447d7d... version 0.4.2
...
var start = function() {
	...
	optionsReportTimeout = setTimeout(optionsReport, 10);
};
...
var optionsReportTimeout;

var optionsReport = function() {
	var gd = global._graphdat;

	gd.gdLog(gd.logType.Info, 'Graphdat (v%s) is %s', gd.version, gd.enabled ? 'enabled' : 'disabled');
...
Graphdat.prototype.config = function(opt) {
	clearTimeout(optionsReportTimeout);
